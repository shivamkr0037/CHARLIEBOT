        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await DxStreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://graph.org/file/46b46fe49516323767338.jpg",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>Something went wrong</i> <b> <a href='https://t.me/randomlychats'>CLICK HERE FOR SUPPORT </a></b>",
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Support](https://t.me/randomlychats).",
                disable_web_page_preview=True)
            return
